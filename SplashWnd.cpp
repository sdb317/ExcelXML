...
void CSplashWnd::SetImage( Gdiplus::Bitmap* pImage )
{
...
// 	if (pImageStream)
// 	{
// 		m_pImage = new Gdiplus::Bitmap(pImageStream);
...
void CSplashWnd::Show()
{
	if (m_hThread == NULL)
	{
		...
		// CSplashWnd::SplashThreadProc(static_cast<LPVOID>(this));
...
unsigned int __stdcall CSplashWnd::SplashThreadProc( void* lpParameter )
{
    ...
    MessageBox(NULL,L"running...",L"",MB_OK);
