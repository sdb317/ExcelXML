...
protected:
	...
	Gdiplus::Bitmap*			m_pImage;					//!< Выводимое изображение 
...
public:
	...
	void SetImage(Gdiplus::Bitmap* pImage);		//!< Задать изображение явно. pImage можно удалять сразу после вызова этой ф-ии.
